...
scatter_points = scatterPoints('DSC_9745.JPG',ori3,loc3,intrinsicsMat',ply_vertex_coord,ply_faces,[6,5,4,3]);
scatter_points_merged = [scatter_points_merged;scatter_points];
3

loc4 = loc_matrix(4,1:3);
ori4 = orient_matrix(10:12,1:3);
scatter_points = scatterPoints('DSC_9746.JPG',ori4,loc4,intrinsicsMat',ply_vertex_coord,ply_faces,[4,3,5,6,1,2]);
scatter_points_merged = [scatter_points_merged;scatter_points];
4

loc5 = loc_matrix(5,1:3);
ori5 = orient_matrix(13:15,1:3);
scatter_points = scatterPoints('DSC_9747.JPG',ori5,loc5,intrinsicsMat',ply_vertex_coord,ply_faces,[1,2,5,6]);
scatter_points_merged = [scatter_points_merged;scatter_points];
5

loc6 = loc_matrix(6,1:3);
ori6 = orient_matrix(16:18,1:3);
scatter_points = scatterPoints('DSC_9748.JPG',ori6,loc6,intrinsicsMat',ply_vertex_coord,ply_faces,[1,2,6,7,5,6]);
scatter_points_merged = [scatter_points_merged;scatter_points];
6

loc7 = loc_matrix(7,1:3);
ori7 = orient_matrix(19:21,1:3);
scatter_points = scatterPoints('DSC_9749.JPG',ori7,loc7,intrinsicsMat',ply_vertex_coord,ply_faces,[7,8,5,6]);
scatter_points_merged = [scatter_points_merged;scatter_points];
7
